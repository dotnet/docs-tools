...
var host = new HostBuilder()
    ...
    .ConfigureServices(services =>
    {
        ...
        {
            // The Application Insights SDK adds a default logging filter that instructs ILogger to capture only
            // Warning and more severe logs. Application Insights requires an explicit override.
