...
Create an automation in Scout to run it:

- Put these instructions in the **Do This** section of a new automation:
...
- I set this to run each Monday at 9am.
- I set **Notify in Teams** to **Always**